        ...
        <form class="space-y-6" @submit.prevent="handleLogin">
          <div>
            ...
            <input 
              ...
              type="text" 
              required 
              class="w-full pl-4 pr-4 py-3 bg-white/10 dark:bg-black/20 border border-white/20 rounded-lg placeholder-white/50 focus:bg-white/20 dark:focus:bg-black/30 focus:ring-2 focus:ring-primary-400 focus:outline-none transition" 
